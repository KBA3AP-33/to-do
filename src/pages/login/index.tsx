    ...
    <AuthLayout>
      <Card className="w-full max-w-md shadow-xl rounded-2xl">
        <div className="text-center mb-8">
          ...
          <Text className="!text-gray-600">Войдите в свой аккаунт</Text>
        </div>
        ...
        <Form form={form} onFinish={login} layout="vertical" autoComplete="off">
          ...
          <div className="text-center mb-4">
            <Text className="!mt-2 !text-gray-600">
              Нет аккаунта?{' '}
              <Link to={ROUTES.registration} className="font-medium transition-colors duration-200">
                Зарегистрироваться
              </Link>
            </Text>
          </div>
          ...
          <Flex vertical className="text-center">
            <Text className="!mt-2 !text-gray-600">
              Вернуться{' '}
              <Link to={ROUTES.index} className="font-medium transition-colors duration-200">
                На главную
              </Link>
            </Text>
          </Flex>
